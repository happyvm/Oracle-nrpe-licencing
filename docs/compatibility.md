...
La parade est `tests/run_parity_tests.sh` : 41 cas comparent le code
...
| Suites Unix | 102 + 27 tests, rejoués sous chacun des trois shells |
...
| Volume total | **428 exécutions de test**, neuf jeux de référence (9i à 21c) |
| Parité des trois moteurs | 41 cas comparés, codes retour et ligne de statut, détection de divergence vérifiée par injection |
